...
**Key Insight:** The pre-hook pattern processes images **before** the agent executes, enriching the request with extracted ingredients. This eliminates an extra LLM round-trip and keeps the agent focused on recipe selection.
